...
public class CloneRemoteRepositoryIntoMemoryAndReadFile {
  //  private static final String REMOTE_URL = "https://github.com/github/testrepo.git";
	private static final String REMOTE_URL = "https://github.com/winfoangular/angular-practice.git";
    private static final String BRANCH = "master";
    private static final String FILE_TO_READ = "test-app/angular.json";
